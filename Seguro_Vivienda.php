...
<head>
	<meta charset="utf-8">
	<title>Seguro de Vivienda</title>
...
<body class="form-v10">
	<div class="page-content">
		<div class="form-v10-content">
			<form class="form-detail" action="Mostrar_Vivienda.php" method="post" >


				<div class="form-left">

					<h2>DATOS NECESARIOS PARA EL SEGURO DE VIVIENDA</h2>
					
					<div class="form-group">
						<div class="form-row form-row-1">
							<label><b>Ingrese Nombres</b></label>
					...
					<div class="form-row">
					<label><b>¿Qué Deseas Asegurar?</b></label>
